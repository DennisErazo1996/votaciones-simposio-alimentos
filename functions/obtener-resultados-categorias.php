...
$sql = "WITH CategoriasConVotos AS (
    ...
    GROUP BY v.id_categoria, c.descripcion, p.descripcion, o.descripcion
)
,
...
SELECT cv.id_categoria, cv.categoria, upper(cv.descripcion_trabajo) as descripcion_trabajo, cv.votos
